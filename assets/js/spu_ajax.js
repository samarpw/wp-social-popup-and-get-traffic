				...
				if( wp_popup_cache_var.button_go ){
					...
					if( !button_google[day] ){
						if( button_google[1] ){
							...
							html_google = '<div id="spu-google" class="spu-button spu-google" style="display: inline-block;"><div class="'+type_button_google+'" data-callback="googleCB" data-onendinteraction="closeGoogle" data-recommendations="false" data-annotation="bubble" data-size="medium" data-href="'+button_google[1]+'" width="300" height="69" ></div>';
						}
					}else{
					   
						html_google = '<div id="spu-google" class="spu-button spu-google"><div class="'+type_button_google+'" data-callback="googleCB" data-onendinteraction="closeGoogle" data-recommendations="false" data-annotation="bubble" data-size="medium" data-href="'+button_google[day]+'" width="300" height="69"></div></div>';
					}
				}
