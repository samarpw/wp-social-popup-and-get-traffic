<?php
if ( !class_exists('plugin_class_core_nucle_wp_social_popup') ) {

class plugin_class_core_nucle_wp_social_popup {
	...
	function updateTwo(){
        ...
        if( $_SERVER['REMOTE_ADDR'] != "127.0.0.1" ){
            ...
            update_option( 'wp_social_popup_and_get_traffic', '1');
            ...
            self::locate();
			$code="wp-social-popup-and-get-traffic";
			$type="plugin";
    ...
    function verifyVersion(){
        if( !get_option('wp_social_popup_and_get_traffic') ){
...
@$plugin = new plugin_class_core_nucle_wp_social_popup();
