...
class wp_social_popup_make{
    ...
    function getHeaderPlugin(){
        ...
        return array('id'             =>'wp_social_popup_id',
                     ...
                     'logo'           =>'<img src="'.plugins_url()."/wp-social-popup-and-get-traffic/assets/images/logo.png".'" style="width: 79px;margin-right: 20px;position: relative;top: -16px;opacity: .8;" />',
